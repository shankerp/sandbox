...
int g_initialized = 0;
static cairo_font_face_t* create_cairo_font_face_for_file (const char *filename, FT_Long faceindex, int loadoptions)
{
    global _freetype_so
    global _cairo_so
    global _ft_lib
...
if __name__ == '__main__':
    ...
    face = create_cairo_font_face_for_file ("/usr/share/fonts/truetype/ttf-dejavu/DejaVuSerif.ttf", 0)
